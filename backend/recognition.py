...
VERTEXAI_ENDPOINT_NAME = (
    "projects/277080682977/locations/us-west1/endpoints/5601308056076943360"
)

ENDPOINT_ID="5601308056076943360"
PROJECT_ID="277080682977"
INPUT_DATA_FILE="INPUT-JSON"

# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "cloud-vision-credentials.json"
...
def vertex_ai_endpoint_predict_sample(project: str, location: str, instances) -> int:
    ...
    #logger.info(endpoint.display_name)
...
def detect_celebrity_from_fine_tuned_resnet50(image: bytes) -> Optional[str]:
    ...
    prediction = vertex_ai_endpoint_predict_sample(
        project="face-detection", location="us-west1", instances=instances
    )
